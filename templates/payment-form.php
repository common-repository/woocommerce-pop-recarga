...
<fieldset id="pop-recarga-fields">
	<p class="form-row form-row-first">
		...
		<input id="pop-recarga-code" class="input-text" type="tel" autocomplete="off" maxlength="2" style="font-size: 1.5em; padding: 8px; width: 20%;" /> <input id="pop-recarga-number" class="input-text" type="tel" autocomplete="off" maxlength="9" pattern=".{8,9}" title="<?php esc_attr_e( 'Please enter with a valid phone number with 8 or 9 digits', 'woocommerce-pop-recarga' ); ?>" style="font-size: 1.5em; padding: 8px; width: 75%;" />
	</p>
